...
SONAR_EXCLUSIONS="${SONAR_EXCLUSIONS:-**/node_modules/**,**/dist/**,**/build/**,**/.git/**,**/*.png,**/*.jpg,**/*.jpeg,**/*.gif,**/*.js,**/*.jsx,**/*.ts,**/*.tsx,**/*.css}"
export SONAR_SCANNER_OPTS="${SONAR_SCANNER_OPTS:--Xmx384m -Djava.net.preferIPv4Stack=true}"
